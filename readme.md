...
The **@obvia/collections** project takes security vulnerabilities seriously.
...
The **@obvia/collections** project is published as open source software under the **[MIT License](license.md)**,
